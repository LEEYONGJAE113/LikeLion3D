...
public class CombatMovementState : State<EnemyController>
{
    ...
    public override void Execute()
    {
        ...
        else if (state == AICombatStates.Circling)
        {
            ...
            // transform.RotateAround(enemy.Target.transform.position, Vector3.down, circlingSpeed * circlingDir * Time.deltaTime);
            ...
            enemy.NavMeshAgent.Move(rotatePos - vecToTarget);
